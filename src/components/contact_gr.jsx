...
const Contact_gr = () => {
    ...
    return <div className="content">
        <div className="content_contact" onAnimationStart={() => {
            ...
            <p style={{ fontSize: " clamp(.7rem, 2.5vw, .8rem)", marginBottom: "2rem", marginInline: "auto", whiteSpace: "pre-line", width: "58ch" }}>Για να επικοινωνήσετε μαζί μου συμπληρώστε την παρακάτω φόρμα, με το email σας και το μήνυμα σας, ή γράψτε μου στο&nbsp;
