    ...
    return <div className="content">
        <div className="content_portfolio">
            <div className="mouseia">
                <div className="description_div mouseia_desc">
                    <p>ΜΟΥΣΕΙΑ ΛΕΣΒΟΥ</p>
            ...
            <div className="eye">
                <div className="description_div eye_desc">
                    <p>EYE</p>
                    <span>aksmdlkamsdlkamsdlkasmldmaslk</span>
                </div>
            ...
            <div className="swlyn">
                <div className="description_div swlyn_desc">
                    <p>ΣΩΛΥΝ</p>
                    <span>aksmdlkamsdlkamsdlkasmldmaslk</span>
                </div>
            ...
            <div className="warehouse">
                <div className="description_div warehouse_desc">
                    <p>ΑΠΟΘΗΚΗ</p>
                    <span>aksmdlkamsdlkamsdlkasmldmaslk</span>
                </div>
            ...
            <div className="woocommerce">
                <div className="description_div woocomerce_desc">
                    <p>E-KIOSK</p>
                    <span>aksmdlkamsdlkamsdlkasmldmaslk</span>
                </div>
            ...
            <div className="express">
                <div className="description_div express_desc">
                    <p>MONGOXPRESS</p>
                    <span>aksmdlkamsdlkamsdlkasmldmaslk</span>
                </div>
            ...
            <div className="cv">
                <div className="description_div cv_desc">
                    <p>CV</p>
                    <span>aksmdlkamsdlkamsdlkasmldmaslk</span>
                </div>
                <img src="#"></img>
