...
const Contact_eng = () => {
    ...
    return <div className="content">
        <div className="content_contact" onAnimationStart={() => {
            ...
            <p style={{ fontSize: " clamp(.7rem, 2.5vw, .8rem)", marginBottom: "2rem", marginInline: "auto", lineHeight: "1.4rem", whiteSpace: "pre-line", width: "58ch" }}>To contact me fill the form bellow with<br />your email address and message, or email<br /> me at&nbsp;
